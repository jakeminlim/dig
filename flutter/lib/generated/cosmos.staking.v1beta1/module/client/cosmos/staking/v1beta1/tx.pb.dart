...
class MsgCreateValidator extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$11.Description>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'description',
        subBuilder: $11.Description.create)
    ..aOM<$11.CommissionRates>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'commission',
        subBuilder: $11.CommissionRates.create)
    ..aOS(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(1)
  set description($11.Description v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set commission($11.CommissionRates v) {
    setField(2, v);
  }
