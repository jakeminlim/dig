...
class Header extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$10.Consensus>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'version',
        subBuilder: $10.Consensus.create)
    ..aOS(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(1)
  $10.Consensus ensureVersion() => $_ensure(0);
...
class LightBlock extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$11.ValidatorSet>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'validatorSet',
        subBuilder: $11.ValidatorSet.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $11.ValidatorSet ensureValidatorSet() => $_ensure(1);
}
